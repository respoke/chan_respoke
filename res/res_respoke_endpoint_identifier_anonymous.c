...
{
	return ast_sorcery_retrieve_by_id(respoke_get_sorcery(), RESPOKE_ENDPOINT, "anonymous");
}

static struct respoke_endpoint_identifier anonymous_identifier = {
	.identify = identify
};

static int unload_module(void)
{
	respoke_unregister_endpoint_identifier(&anonymous_identifier);
	return 0;
}

static int load_module(void)
{
	return respoke_register_endpoint_identifier(&anonymous_identifier) ?
